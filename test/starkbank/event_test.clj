...
(deftest query-get-update-delete-events
  (testing "query, get, update and delete events"
    (def event (first (event/query {:limit 10 :is-delivered false})))
