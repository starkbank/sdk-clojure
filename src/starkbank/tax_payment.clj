...
(defn delete
  "Cancel a scheduled TaxPayment entity before it starts being processed. Payments that have already been processed can still be deleted, but can no longer be cancelled.
