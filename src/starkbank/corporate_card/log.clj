(ns starkbank.corporate-card.log
  ...
  ## Attributes (return-only):
    ...
    - `:type` [string]: type of the CorporateCard event which triggered the log creation. ex: \"blocked\", \"canceled\", \"created\", \"expired\", \"unblocked\" or \"updated\"
...
(defn query
  ...
  ## Options:
    ...
    - `:card-ids` [list of strings, default nil]: list of CorporateCard ids to filter logs. ex: [\"5656565656565656\", \"4545454545454545\"]
